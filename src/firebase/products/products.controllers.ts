import { QueryFieldFilterConstraint, collection, orderBy, where } from "firebase/firestore";
...
export const mainCategoryQuery = (field:string, value:string):QueryFieldFilterConstraint => 
    where(field, '==', value)
